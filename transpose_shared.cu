...
int main( void ){
    ...
    transpose<<< grid, tblocks, tblocks.x*tblocks.y*sizeof(int) >>>(dev_a, dev_c, ROW, COL);
...
//  --------  ---------------  ---------  --------  --------  --------  --------  -----------  --------------  --------------  ---------------------------------
//     100.0           21’824          1  21’824.0  21’824.0    21’824    21’824          0.0    17   17    1    32   32    1  transpose(int *, int *, int, int)